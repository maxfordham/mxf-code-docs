...
- [x] organise leaving drinks
- [x] Brief Dan and devs on the DNG tool current status
- [ ] Email the Project Administrators and the DNG
- [ ] feedback on [SDLC](https://maxfordham0-my.sharepoint.com/:w:/g/personal/d_kelly_maxfordham_com/IQBP5fYIlwE9TZb-UxCLP95aAUliDOWzWRj83-jf_k8vjrM?wdExp=TEAMS-TREATMENT&web=1)
- [ ] update room data sheet docs based on Kathryn's feedback
- [ ] move ipyautoui to jupyter-widgets-contributors
- [ ] move bdns-plus to theodi
